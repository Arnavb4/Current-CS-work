public class Measure implements Comparable<Measure>
{
   ...
   public float converTo(Measure other){
      return other.getFeet() + (other.getInches() / 12);
   }
   
   public void revertTo(Measure other, float decimal){
      other.setFeet((int)(decimal));
      other.setInches((int)(decimal - other.getFeet()) * 12);
   }
